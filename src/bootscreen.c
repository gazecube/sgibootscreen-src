...
static void draw_bootscreen_new(const bootscreen_new_t * const bs)
{
    ...
    draw_mapcolor(35, 42, 42, 42);
    draw_mapcolor(36, 85, 85, 85);
    draw_mapcolor(37, 128, 128, 128);
    draw_mapcolor(38, 170, 170, 170);
    draw_mapcolor(39, 213, 213, 213);
    draw_mapcolor(51, 85, 85, 85);
    draw_mapcolor(52, 198, 113, 113);
    draw_mapcolor(53, 113, 198, 113);
    draw_mapcolor(54, 142, 142, 56);
    draw_mapcolor(55, 113, 113, 198);
    draw_mapcolor(56, 142, 56, 142);
    draw_mapcolor(57, 56, 142, 56);
    draw_mapcolor(58, 170, 170, 170);
    u8 i = BGND_IDX;
    ...
    /* GraVT has more visual mass on the left than the stock Indy mark. */
    if (bs == &bs_ip24indy) {
        logo_x += 10;
    }
